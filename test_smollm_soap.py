"""Test fine-tuned SmolLM model on SOAP summary generation from medical dialogues."""
...
model_path = "/content/smollm_soap_finetuned/final_model"  # Path to fine-tuned model
...
results_path = "/Users/rajarshichatterjee/Desktop/NLP_FOR_HEALTHCARE/Voice Case Summarizer/test_results.json"  # Path to save results
...
def load_model_and_tokenizer(model_path: str):
    ...
    try:
        ...
        base_model_path = "HuggingFaceTB/SmolLM2-1.7B-Instruct"
...
def test_model():
    ...
    logger.info("="*80)
    logger.info("SmolLM SOAP Summary Generation - Testing Pipeline")
    logger.info("="*80)
